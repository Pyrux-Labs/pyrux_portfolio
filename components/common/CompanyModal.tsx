...
export default function CompanyModal({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} closeLabel={t("closeModal")}>
            ...
            <div className="flex items-center justify-between gap-4 sm:pr-10">
                <div>
                    <h3 className="font-display text-xl font-bold text-primary">
                        {company.name}
                    </h3>
                    <p className="mt-6 text-secondary text-sm leading-relaxed w-full">
                        {company.summary}
                    </p>
                </div>
                <div className="w-16 h-16 sm:w-20 sm:h-20 shrink-0 rounded-full border border-border bg-elevated flex items-center justify-center overflow-hidden p-2">
            ...
            {/* Testimonial — centrado en su contenedor */}
            {company.testimonial && (
                <div className="p-4 rounded-xl border border-border bg-elevated mb-6">
                    <div className="flex items-start gap-3">
                        ...
                        />
                        <blockquote className="text-[0.9rem] text-secondary italic leading-relaxed text-center flex-1">
